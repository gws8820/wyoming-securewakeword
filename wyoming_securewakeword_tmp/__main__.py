...
from .handler import SecureWakeWordEventHandler, ensure_loaded
from .securewakeword import embeddings_proc, mels_proc
...
async def main() -> None:
    ...
    try:
        await server.run(partial(SecureWakeWordEventHandler, args, state))
